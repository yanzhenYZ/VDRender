...
@interface VEDRCapture ()<AVCaptureVideoDataOutputSampleBufferDelegate>
...
@implementation VEDRCapture
- (void)dealloc
{
    [NSNotificationCenter.defaultCenter removeObserver:self];
    NSLog(@"VEDRCapture---dealloc");
}
...
- (void)configSession {
    ...
    camera.activeVideoMaxFrameDuration = CMTimeMake(1, 20);
