...
void EUSEYXVideoCompressionOutputCallback(void *outputCallbackRefCon,
...
@implementation EUseH264HwEncoder {
...
- (void)startEncode:(int)width height:(int)height {
    OSStatus status = VTCompressionSessionCreate(NULL, width, height, kCMVideoCodecType_H264, NULL, NULL, NULL, EUSEYXVideoCompressionOutputCallback, (__bridge void *)(self), &_encodeSession);
