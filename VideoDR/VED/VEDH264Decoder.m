...
-(void)decodeData:(NSData *)data{
    ...
    switch (nalu_type)
    {
        case 0x05://IDR frame  I帧-关键帧
        {
            ...
            if ([_delegate respondsToSelector:@selector(decoder:didOutputSampleBuffer:)]) {
                [_delegate decoder:self didOutputSampleBuffer:samplebuffer];
            }
