...
void VEDVideoCompressionOutputCallback(void *outputCallbackRefCon,
                                      ...
                                      CMSampleBufferRef sampleBuffer)
{
    ...
    VEDH264Encoder *encoder = (__bridge VEDH264Encoder *)outputCallbackRefCon;
...
- (void)startEncode:(int)width height:(int)height {
    OSStatus status = VTCompressionSessionCreate(NULL, width, height, kCMVideoCodecType_H264, NULL, NULL, NULL, VEDVideoCompressionOutputCallback, (__bridge void *)(self), &_encodeSession);
